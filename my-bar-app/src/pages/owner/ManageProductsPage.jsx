...
const ManageProductsPage = () => {
  ...
  const uploadImage = async () => {
    if (!imageFile) return formData.image_url; // Return existing URL if no new file
    ...
    <div>
      ...
      >
        <div style={{ padding: '20px', background: '#fff', border: '1px solid #e2e8f0', borderRadius: '12px' }}>
          ...
          <div style={{ fontSize: '32px', fontWeight: '700', color: '#667eea' }}>{products.length}</div>
        </div>
        <div style={{ padding: '20px', background: '#fff', border: '1px solid #e2e8f0', borderRadius: '12px' }}>
      ...
      {/* Products grid */}
      {products.length === 0 ? (
        <div style={{ textAlign: 'center', padding: '60px 20px', background: '#f7fafc', borderRadius: '12px' }}>
          <p style={{ fontSize: '18px', color: '#666', marginBottom: '10px' }}>No products yet</p>
          <p style={{ fontSize: '14px', color: '#999' }}>Click "Add Product" to create your first product</p>
        </div>
      ) : (
        <div style={{ background: '#fff', borderRadius: '12px', overflow: 'hidden' }}>
          ...
          <div
            style={{
              display: 'grid',
              gridTemplateColumns: '1fr 120px 100px 120px 120px 200px',
              padding: '16px 20px',
              background: '#f7fafc',
