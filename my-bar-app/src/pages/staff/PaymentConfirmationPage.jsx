...
const PaymentConfirmationPage = () => {
  ...
  const handleConfirm = async (transactionId) => {
    try {
      ...
      const { error } = await confirmTransaction(
        transactionId,
        userProfile.id,
      );
      ...
      <div style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto' }}>
        ...
        >
          <div style={{ display: 'flex', gap: '20px', alignItems: 'center' }}>
            ...
            {selectedIds.length > 0 && (
              <div style={{ fontSize: '14px', color: '#666' }}>
                <strong style={{ fontSize: '18px', color: '#d4af37' }}>{selectedIds.length}</strong>{' '}
                Selected
              </div>
            )}
          </div>
        ...
        {filteredTransactions.length === 0 ? (
          ...
          >
            ...
            <p style={{ fontSize: '14px', color: '#999' }}>All payments have been processed</p>
          </div>
        ) : (
        ...
        >
          <p style={{ margin: 0 }}>
            💡 <strong>Tip:</strong> Select multiple payments using checkboxes and click &quot;Confirm
            Selected&quot; to process them in bulk. Confirming a payment automatically generates a QR
