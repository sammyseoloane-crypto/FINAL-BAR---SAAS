                ...
                <div className="card-body">
                  ...
                  <div style={{ marginBottom: '15px' }}>
                    <p style={{ margin: '5px 0' }}>
                      <strong>Customer:</strong> {trans.users?.email || 'Unknown'}
                    </p>
                    <p style={{ margin: '5px 0' }}>
                      <strong>Product:</strong> {trans.products?.name || 'N/A'}
                    </p>
                    <p style={{ margin: '5px 0', fontSize: '1.3em', color: '#d4af37' }}>
                  ...
                  <div style={{ display: 'flex', gap: '10px' }}>
                    ...
                    <button className="btn btn-danger" onClick={() => cancelTransaction(trans.id)}>
                      ✗ Cancel
                    </button>
                  </div>
                </div>
