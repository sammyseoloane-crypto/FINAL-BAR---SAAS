...
export default function QRCodesPage() {
  ...
  const fetchQRCodes = async () => {
    try {
      const { data, error } = await supabase
        .from('qr_codes')
        .select('*, transactions(amount, status, type, metadata, products!product_id(name, type), events!event_id(name, date, active))')
        .eq('user_id', user.id)
  ...
  const downloadQRCode = (qr, index = null) => {
    ...
    const productTypeRaw =
      qr.transactions?.metadata?.product_type || qr.transactions?.products?.type;
    const productName =
        ...
        {loading ? (
          ...
          <>
            {activeQRCodes.length > 0 && (
              <>
                <h3 style={{ marginBottom: '15px', color: '#d4af37' }}>✅ Active QR Codes</h3>
                  ...
                  {expiredQRCodes.map((qr) => (
                    ...
                    >
                      <div className="card-body">
                        ...
                        >
                          <strong>⚠️ This QR code expired after 24 hours</strong>
                          <br />
        ...
        <div className="card">
          ...
          <div className="card-body">
            <ol style={{ lineHeight: '1.8' }}>
              ...
              <li>
                <strong>⏰ QR codes are valid for 24 hours only</strong> - use them promptly!
              </li>
              ...
              <li>
                <strong>
                  🗑️ Old QR codes are automatically removed after 48 hours of expiring
                </strong>{' '}
                (72 hours total)
              </li>
            </ol>
            ...
            >
              ...
              <ul style={{ marginTop: '10px', marginBottom: '0', paddingLeft: '20px' }}>
                <li>
                  <strong>0-24 hours:</strong> Active & scannable ✅
                </li>
                <li>
                  <strong>24-72 hours:</strong> Expired but visible ⏰
                </li>
                <li>
                  <strong>After 72 hours:</strong> Automatically removed 🗑️
                </li>
              </ul>
            </div>
          </div>
